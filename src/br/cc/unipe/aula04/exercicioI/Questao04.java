...
public class Questao04 {
	...
	/*4.	Uma empresa decidiu dar 20% de aumento aos funcionários cujos salários são inferiores a 500 reais. 
	 * Escreva um programa que leia o salário de vários funcionários se mostre o valor do salário reajustado ou uma mensagem caso o 
	...
	public static void main(String[] args) {
		...
		System.out.println("Obrigado pela compreensão e por utilizar o software de nossa empresa.");
	}
}
